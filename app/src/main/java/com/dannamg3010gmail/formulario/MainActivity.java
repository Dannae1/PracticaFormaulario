package com.dannamg3010gmail.formulario;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviar = (Button) findViewById(R.id.editText);
        editTextNombre = (EditText) findViewById(R.id.editText2);
        editTextDireccion = (EditText) findViewById(R.id.editText3);
        editTextTelefono = (EditText) findViewById(R.id.editText4);
